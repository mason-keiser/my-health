...
export default function Welcome (props) {
    return (
        <div className='wel'>
            ...
            <h3 className='title4 mt-5 ml-2'> •  Input daily pain level and mood level </h3>
            <h3 className='title4 ml-2'> •  Keep a medical journal for everything you need to keep track of  </h3>
